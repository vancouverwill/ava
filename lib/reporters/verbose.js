...
class VerboseReporter {
	...
	addTestRunning(evt) {
		...
		if (!this.runningTestFiles.has(evt.testFile)) {
			this.runningTestFiles.set(evt.testFile, new Set());
		}
		this.runningTestFiles.get(evt.testFile).add(evt.title);
	}

	removeTestRunning(evt) {
		this.runningTestsCount--;
		this.runningTestFiles.get(evt.testFile).delete(evt.title);
	}
